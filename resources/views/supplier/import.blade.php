<form action="{{ url('/m_supplier/import_ajax') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
  ...
  $(document).ready(function() {
    $("#form-import").validate({
      ...
      submitHandler: function(form) {
        var formData = new FormData(form); // FormData untuk handle file
